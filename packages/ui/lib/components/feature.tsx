...
const Feature = ({ feature }: { feature: LunarFeature }) => {
  return (
    <li className="xs:max-w-md flex flex-row flex-nowrap items-center justify-between rounded-md border-2 bg-gray-300 shadow-md shadow-gray-600 dark:bg-gray-600 dark:shadow-gray-400">
